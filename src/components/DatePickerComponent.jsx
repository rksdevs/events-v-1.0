...
const DatePickerComponent = ({
  ...
  useEffect(() => {
    ...
    // const setEventReminder = (dateInput, frequencyInput) => {
    //   let reminders = [];
    ...
    //     return reminders;
    //   }
    //   const startDate = new Date(dateInput?.from);
    //   const endDate = new Date(dateInput?.to);
    //   console.log(dateInput);
    //   console.log(startDate, endDate, frequency);
    //   //function to add days to a date for daily frequency
    ...
    //   //function to add months to a date for monthly frequency
    ...
    //   //function to add years to a date for yearly frequency
    ...
    //     reminders.push(new Date(current)); // Add the reminder to the array

    //     // Adjust the current date based on the frequency
    //     switch (frequencyInput.toLowerCase()) {
    //       case "daily":
    ...
    //       default:
    //         throw new Error(
    //           "Invalid frequency. Please use daily, weekly, monthly, or yearly."
    //         );
    //       // break;
    //     }
    //   }
    ...
    const generateReminders = (
      ...
      //   let startDate =
      console.log(dateInput?.from, dateInput?.to, "test to check both dates");
